...
const Footer = () => {
    ...
    <a className="link link-hover">GitHub</a>
              ...
              <nav>
                ...
                <a className="link link-hover text-xl ">Email: <span className=" font-bold">minhazaponcodingwarrior@gmail.com</span>
                </a>
                <a className="link link-hover text-xl ">Call Me: <span className=" font-bold">+8801950374409</span></a>
